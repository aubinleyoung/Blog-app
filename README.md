...
**[Blog-app]** is a classic example of a blog website. It is a functional website that show the list of posts and empower readers to interact with them by adding comments and liking posts.
...
```sh
git clone https://github.com/aubinleyoung/Blog-app.git
...
Feel free to check the [issues page](https://github.com/aubinleyoung/Blog-app/issues).
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
If you like this project then please do follow me and give a ⭐️ to this repo.
